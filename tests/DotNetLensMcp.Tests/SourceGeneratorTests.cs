...
{
    private const string TestProjectName = "DotNetLensMcp.Tests";
    private const string MainProjectName = "DotNetLensMcp";
    private const string ConsumerFileName = "SourceGeneratorFixture.cs";

    private string GetConsumerFilePath()
    {
        var solutionDir = Path.GetDirectoryName(SolutionPath)!;
        return Path.Combine(solutionDir, "tests", "DotNetLensMcp.Tests", ConsumerFileName);
    }
